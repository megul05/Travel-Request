    ...
    <div id="form">
      ...
      <div id="details">
        <form action="../mode/mode.php" method="POST" id="basic_details">
          ...
          <select class="country" id="countryS" style="width: 120px" name="country" id="" required>
            <option value=""></option>
           

          </select>
          <label class="state" for="state">State</label>
          <select class="state" id="stateS" style="width: 120px" name="state" id="" required onclick="getState()">
            <option value=""></option>
          </select> 

          <label class="fromCity" for="fromCity">From city</label>
          <select class="fromCity" id="fromCityS" name="fromCity" id="" required onclick="getCity()">
            <option value=""></option>
            
          </select>

          <label class="toCity" for="toCity">To city</label>
          <select class="toCity" id="toCityS" name="toCity" id="" required onclick="getCityF()">
            <option value=""></option>
          </select>
